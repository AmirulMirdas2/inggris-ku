...
export default function Landing() {
  return (
    <div className="animate-fade-up mx-auto flex min-h-dvh max-w-md flex-col items-center justify-center gap-6 p-6 text-center">
      <PixelIcon name="sprout" size={80} className="animate-bob" />
      <h1 className="pixel-title text-2xl text-brand md:text-3xl">InggrisKu</h1>
      ...
      <p className="text-sm muted">Gratis · Bisa dipasang seperti aplikasi</p>
    </div>
  )
}
